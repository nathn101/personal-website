                ...
                <div className="about">
                    ...
                    <div className="about-details">
                        <ul>
                            ...
                            <li><p>I am currently working at Global X Canada as a Quantitative Developer. On a day-to-day basis, I make use of Python to modernize existing processes, to improve both trade execution and strategy development in the midst of ETF decision making. Some of my notable projects include, using luigi to assist with better task scheduling for daily processes and building a new feature for Fixed Income trading stratgy into the in-house trading tool</p></li>
